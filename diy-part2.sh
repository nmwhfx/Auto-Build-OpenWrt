...
# 修改版本号
sed -i "s/OpenWrt /NMWHFX Build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings

# 修改默认wifi名称ssid为WHHWTX
#sed -i 's/ssid=OpenWrt/ssid=WHHWTX/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
